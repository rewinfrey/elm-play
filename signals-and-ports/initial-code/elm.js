...
Elm.Main.make = function (_elm) {
   ...
   var runningTime = A3($Signal.foldp,F2(function (second,count) {    return count + 1;}),0,everySecond);
   var main = A2($Signal.map,$Graphics$Element.show,runningTime);
   return _elm.Main.values = {_op: _op,everySecond: everySecond,runningTime: runningTime,main: main};
};
